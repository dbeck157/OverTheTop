...
public class NewMachinePistol : NewWeapon
{
    ...
    void Awake()
    {
        base.shootableMask = LayerMask.GetMask("Shootable");
        base.gunParticles = GetComponent<ParticleSystem>();
        base.gunLine = GetComponent<LineRenderer>();
        base.gunAudio = GetComponent<AudioSource>();
        base.gunLight = GetComponent<Light>();
    }
